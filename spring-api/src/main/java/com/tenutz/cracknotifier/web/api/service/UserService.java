...
import com.tenutz.cracknotifier.web.api.exception.business.CInvalidValueException.CEmailLoginFailedException;
import com.tenutz.cracknotifier.web.api.exception.security.CTokenException.CRefreshTokenException;
...
public class UserService {
    ...
    public TokenResponse reissue(TokenRequest request) {
        ...
        User foundUser = userThrowable(((User)authentication.getPrincipal()).getSeq());
    ...
    private User userThrowable(String seq) {
